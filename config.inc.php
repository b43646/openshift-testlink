 ...
 */
$tlCfg->log_path = getenv('OPENSHIFT_DATA_DIR').'logs'; /* openshift path */
...
$g_smtp_host        = 'mail.ksmt.co';  # SMTP server MUST BE configured
...
$g_tl_admin_email     = 'ksmt.dev@gmail.com'; # for problem/error notification
$g_from_email         = 'noreply@ksmt.co';  # email sender
$g_return_path_email  = 'ksmt.dev@gmail.com';
 ...
 *
 **/
$g_repositoryPath = getenv('OPENSHIFT_DATA_DIR').'upload_area';  /* openshift path */
